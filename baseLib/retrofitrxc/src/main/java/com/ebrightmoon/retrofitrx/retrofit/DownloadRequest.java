...
public class DownloadRequest extends BaseHttpRequest<DownloadRequest> {
    ...
    private String dirName = HttpUtils.DEFAULT_DOWNLOAD_DIR;
    private String fileName = HttpUtils.DEFAULT_DOWNLOAD_FILE_NAME;

    protected DownloadRequest(Context context) {
        super(context);
        rootName = getDiskCachePath(mContext);
    }

    public DownloadRequest(Context context, String suffixUrl) {
