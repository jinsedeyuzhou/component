package com.ebrightmoon.derobot.reboot.kit.common;
...
import com.ebrightmoon.derobot.reboot.kit.custom.UploadMonitorInfoBean;
import com.ebrightmoon.derobot.reboot.kit.custom.UploadMonitorItem;
import com.ebrightmoon.derobot.reboot.kit.network.NetworkManager;
import com.ebrightmoon.derobot.reboot.util.FileManager;
import com.ebrightmoon.derobot.reboot.util.JsonUtil;
import com.ebrightmoon.derobot.reboot.util.LogHelper;
import com.ebrightmoon.derobot.reboot.util.threadpool.ThreadPoolProxyFactory;
...
public class PerformanceDataManager {
    ...
    private void saveToLocal() {
        ...
        if (Derobot.getCurrentResumedActivity() != null) {
            pageName = Derobot.getCurrentResumedActivity().getLocalClassName();
        }
        info.page = pageName;
