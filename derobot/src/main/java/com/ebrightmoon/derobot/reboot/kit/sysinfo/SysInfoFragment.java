...
import com.ebrightmoon.derobot.reboot.util.DeviceUtils;
import com.ebrightmoon.derobot.reboot.util.ExecutorUtil;
...
public class SysInfoFragment extends BaseFragment {
    ...
    private void addDeviceData(List<SysInfoItem> sysInfoItems) {
        ...
        sysInfoItems.add(new SysInfoItem("DefaultScaledDensity", String.valueOf(UIUtils.getScaledDensity(getContext()))));
        sysInfoItems.add(new SysInfoItem("ScaledDensity", String.valueOf(UIUtils.getDefaultScaledDensity(getContext()))));
