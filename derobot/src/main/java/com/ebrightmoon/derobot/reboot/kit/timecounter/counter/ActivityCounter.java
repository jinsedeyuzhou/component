package com.ebrightmoon.derobot.reboot.kit.timecounter.counter;

import android.app.Activity;

import com.ebrightmoon.derobot.reboot.Derobot;
import com.ebrightmoon.derobot.reboot.constant.PageTag;
import com.ebrightmoon.derobot.reboot.kit.timecounter.TimeCounterFloatPage;
...
public class ActivityCounter {
    ...
    public void pause() {
        ...
        Activity activity = Derobot.getCurrentResumedActivity();
        if (activity != null) {
    ...
    public void render() {
        ...
        final Activity activity = Derobot.getCurrentResumedActivity();
